...
| :--- | :--- | :--- | :--- |
| **Frontend UI** | Streamlit | **Deployed on streamlit.io** | An interactive, multi-page web application for real-time text analysis and visualization. Run with `[streamlit run ui/app.py](https://cleanspeech.streamlit.app/)`. |
